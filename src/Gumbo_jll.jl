...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import Gumbo_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("528830af-5a63-567c-a44a-034ed33b8444"))
platforms = [Pkg.Artifacts.unpack_platform(e, "Gumbo", artifacts_toml) for e in artifacts["Gumbo"]]
...
if best_platform === nothing
    @debug("Unable to load Gumbo; unsupported platform $(triplet(platform_key_abi()))")
else
